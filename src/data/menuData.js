export const menuData = [
  ...
  // 한식 - 찌개/국물 추가
  { id: 141, name: "청국장", category: "korean-soup", calories: 290, ingredients: ["청국장", "두부", "호박"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2,3], mood: ["comfort", "warm"] },
  { id: 142, name: "삼계탕", category: "korean-soup", calories: 420, ingredients: ["닭", "인삼", "대추"], weatherPreference: "hot", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["healthy", "special"] },
  { id: 143, name: "매운탕", category: "korean-soup", calories: 280, ingredients: ["생선", "두부", "고추"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [2,3,4], mood: ["spicy", "warm"] },
  { id: 144, name: "추어탕", category: "korean-soup", calories: 310, ingredients: ["미꾸라지", "시래기", "된장"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["warm", "healthy"] },
  { id: 145, name: "곰탕", category: "korean-soup", calories: 340, ingredients: ["사골", "소고기", "소금"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "warm"] },
  { id: 146, name: "조개탕", category: "korean-soup", calories: 180, ingredients: ["바지락", "대파", "마늘"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3], mood: ["light", "refreshing"] },

  // 한식 - 구이/볶음 추가
  { id: 147, name: "떡갈비", category: "korean-grill", calories: 380, ingredients: ["소고기", "돼지고기", "양념"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2,3], mood: ["special", "heavy"] },
  { id: 148, name: "닭볶음탕", category: "korean-grill", calories: 350, ingredients: ["닭", "감자", "고추장"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["spicy", "heavy"] },
  { id: 149, name: "보쌈", category: "korean-grill", calories: 420, ingredients: ["돼지고기", "김치", "새우젓"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3,4,5], mood: ["special", "heavy"] },
  { id: 150, name: "족발", category: "korean-grill", calories: 450, ingredients: ["돼지족발", "마늘", "간장"], weatherPreference: "any", timePreference: ["dinner", "late"], groupSize: [2,3,4,5], mood: ["special", "heavy"] },
  { id: 151, name: "매운갈비찜", category: "korean-grill", calories: 420, ingredients: ["갈비", "무", "고추장"], weatherPreference: "cold", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["spicy", "special"] },
  { id: 152, name: "두부김치", category: "korean-grill", calories: 280, ingredients: ["두부", "김치", "돼지고기"], weatherPreference: "any", timePreference: ["dinner", "late"], groupSize: [2,3], mood: ["comfort", "light"] },

  // 한식 - 밥류 추가
  { id: 153, name: "잡채밥", category: "korean-rice", calories: 420, ingredients: ["당면", "채소", "소고기"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "light"] },
  { id: 154, name: "알밥", category: "korean-rice", calories: 380, ingredients: ["날치알", "쌀", "참기름"], weatherPreference: "any", timePreference: ["lunch"], groupSize: [1,2], mood: ["light", "special"] },
  { id: 155, name: "낙지덮밥", category: "korean-rice", calories: 350, ingredients: ["낙지", "쌀", "고추장"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["spicy", "quick"] },
  { id: 156, name: "카레라이스(한식)", category: "korean-rice", calories: 400, ingredients: ["카레", "감자", "당근"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "quick"] },

  // 한식 - 면류 추가
  { id: 157, name: "수제비", category: "korean-noodle", calories: 300, ingredients: ["밀가루", "감자", "호박"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2,3], mood: ["comfort", "warm"] },
  { id: 158, name: "쫄면", category: "korean-noodle", calories: 340, ingredients: ["쫄면", "고추장", "채소"], weatherPreference: "hot", timePreference: ["lunch", "snack"], groupSize: [1,2], mood: ["refreshing", "spicy"] },
  { id: 159, name: "메밀국수", category: "korean-noodle", calories: 280, ingredients: ["메밀면", "무", "간장"], weatherPreference: "hot", timePreference: ["lunch"], groupSize: [1,2], mood: ["light", "refreshing"] },
  { id: 160, name: "들깨수제비", category: "korean-noodle", calories: 320, ingredients: ["밀가루", "들깨", "감자"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["warm", "comfort"] },

  // 중식 추가
  { id: 161, name: "마라샹궈", category: "chinese", calories: 450, ingredients: ["고기", "채소", "마라소스"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["spicy", "special"] },
  { id: 162, name: "꿔바로우", category: "chinese", calories: 400, ingredients: ["돼지고기", "소스", "야채"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [2,3,4], mood: ["special", "comfort"] },
  { id: 163, name: "팔보채", category: "chinese", calories: 320, ingredients: ["해산물", "채소", "굴소스"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [2,3,4], mood: ["light", "special"] },
  { id: 164, name: "볶음짬뽕", category: "chinese", calories: 480, ingredients: ["면", "해산물", "채소"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["spicy", "heavy"] },

  // 일식 추가
  { id: 165, name: "사시미", category: "japanese", calories: 200, ingredients: ["연어", "참치", "광어"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["special", "light"] },
  { id: 166, name: "텐동", category: "japanese", calories: 480, ingredients: ["새우튀김", "쌀", "소스"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["heavy", "comfort"] },
  { id: 167, name: "나베", category: "japanese", calories: 350, ingredients: ["두부", "채소", "다시육수"], weatherPreference: "cold", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["warm", "light"] },
  { id: 168, name: "소바", category: "japanese", calories: 300, ingredients: ["메밀면", "다시", "파"], weatherPreference: "hot", timePreference: ["lunch"], groupSize: [1,2], mood: ["light", "refreshing"] },
  { id: 169, name: "타코야끼", category: "japanese", calories: 280, ingredients: ["밀가루", "문어", "가쓰오부시"], weatherPreference: "any", timePreference: ["snack"], groupSize: [1,2], mood: ["quick", "light"] },

  // 양식 추가
  { id: 170, name: "감바스", category: "western", calories: 350, ingredients: ["새우", "마늘", "올리브오일"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3], mood: ["special", "light"] },
  { id: 171, name: "뇨끼", category: "western", calories: 380, ingredients: ["감자", "밀가루", "치즈"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "warm"] },
  { id: 172, name: "브런치플레이트", category: "western", calories: 450, ingredients: ["계란", "베이컨", "토스트"], weatherPreference: "any", timePreference: ["breakfast", "lunch"], groupSize: [1,2], mood: ["special", "comfort"] },
  { id: 173, name: "까르보나라", category: "western", calories: 480, ingredients: ["파스타", "베이컨", "크림"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "heavy"] },
  { id: 174, name: "포케볼", category: "western", calories: 350, ingredients: ["참치", "아보카도", "쌀"], weatherPreference: "hot", timePreference: ["lunch"], groupSize: [1,2], mood: ["healthy", "refreshing"] },

  // 분식 추가
  { id: 175, name: "만두", category: "street-food", calories: 280, ingredients: ["돼지고기", "두부", "채소"], weatherPreference: "cold", timePreference: ["snack", "lunch"], groupSize: [1,2,3], mood: ["comfort", "warm"] },
  { id: 176, name: "계란빵", category: "street-food", calories: 180, ingredients: ["계란", "밀가루", "설탕"], weatherPreference: "cold", timePreference: ["breakfast", "snack"], groupSize: [1,2], mood: ["warm", "quick"] },
  { id: 177, name: "치즈볼", category: "street-food", calories: 250, ingredients: ["모짜렐라", "튀김옷", "소스"], weatherPreference: "any", timePreference: ["snack"], groupSize: [1,2,3], mood: ["quick", "comfort"] },

  // 패스트푸드 추가
  { id: 178, name: "피시앤칩스", category: "fast-food", calories: 480, ingredients: ["생선", "감자", "타르타르소스"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "heavy"] },
  { id: 179, name: "타코벨", category: "fast-food", calories: 420, ingredients: ["토르티야", "고기", "치즈"], weatherPreference: "any", timePreference: ["lunch", "dinner", "late"], groupSize: [1,2], mood: ["quick", "spicy"] },
  { id: 180, name: "맥앤치즈", category: "fast-food", calories: 450, ingredients: ["마카로니", "치즈", "우유"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "warm"] },

  // 태국 추가
  { id: 181, name: "팟씨유", category: "thai", calories: 400, ingredients: ["넓은쌀국수", "간장", "브로콜리"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "quick"] },
  { id: 182, name: "무쌈", category: "thai", calories: 280, ingredients: ["돼지고기", "양배추", "소스"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [2,3], mood: ["light", "healthy"] },
  { id: 183, name: "레드커리", category: "thai", calories: 400, ingredients: ["고기", "코코넛밀크", "바질"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2,3], mood: ["spicy", "warm"] },

  // 베트남 추가
  { id: 184, name: "반쎄오", category: "vietnamese", calories: 300, ingredients: ["쌀가루", "새우", "숙주"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["light", "special"] },
  { id: 185, name: "카페쓰어다", category: "vietnamese", calories: 150, ingredients: ["커피", "연유", "얼음"], weatherPreference: "hot", timePreference: ["snack"], groupSize: [1,2], mood: ["refreshing", "quick"] },
  { id: 186, name: "반꾸온", category: "vietnamese", calories: 220, ingredients: ["쌀가루", "돼지고기", "버섯"], weatherPreference: "any", timePreference: ["breakfast", "lunch"], groupSize: [1,2], mood: ["light", "healthy"] },

  // 인도 추가
  { id: 187, name: "팔락파니르", category: "indian", calories: 320, ingredients: ["시금치", "파니르치즈", "향신료"], weatherPreference: "any", timePreference: ["lunch", "dinner"], groupSize: [1,2,3], mood: ["healthy", "comfort"] },
  { id: 188, name: "달마크니", category: "indian", calories: 350, ingredients: ["렌틸콩", "토마토", "버터"], weatherPreference: "cold", timePreference: ["lunch", "dinner"], groupSize: [1,2], mood: ["comfort", "warm"] },
  { id: 189, name: "치킨티카마살라", category: "indian", calories: 450, ingredients: ["닭고기", "토마토", "크림"], weatherPreference: "any", timePreference: ["dinner"], groupSize: [1,2,3], mood: ["spicy", "special"] },

  // 멕시칸 추가
  { id: 190, name: "칠리콘카르네", category: "mexican", calories: 380, ingredients: ["소고기", "강낭콩", "토마토"], weatherPreference: "cold", timePreference: ["dinner"], groupSize: [2,3,4], mood: ["spicy", "warm"] },
  { id: 191, name: "과카몰리", category: "mexican", calories: 200, ingredients: ["아보카도", "라임", "토마토"], weatherPreference: "hot", timePreference: ["snack"], groupSize: [2,3], mood: ["healthy", "refreshing"] },
  { id: 192, name: "또르타", category: "mexican", calories: 450, ingredients: ["빵", "콩", "아보카도"], weatherPreference: "any", timePreference: ["lunch"], groupSize: [1,2], mood: ["heavy", "quick"] },

  // 디저트 추가
  { id: 193, name: "크로플", category: "dessert", calories: 350, ingredients: ["크루아상", "아이스크림", "시럽"], weatherPreference: "any", timePreference: ["snack", "breakfast"], groupSize: [1,2], mood: ["special", "comfort"] },
  { id: 194, name: "약과", category: "dessert", calories: 200, ingredients: ["밀가루", "꿀", "참기름"], weatherPreference: "any", timePreference: ["snack"], groupSize: [1,2], mood: ["comfort", "light"] },
  { id: 195, name: "탕후루", category: "dessert", calories: 180, ingredients: ["과일", "설탕", "물엿"], weatherPreference: "any", timePreference: ["snack"], groupSize: [1,2], mood: ["refreshing", "quick"] },
  { id: 196, name: "팥빙수", category: "dessert", calories: 300, ingredients: ["팥", "얼음", "떡"], weatherPreference: "hot", timePreference: ["snack"], groupSize: [1,2,3], mood: ["refreshing", "comfort"] },
  { id: 197, name: "츄러스", category: "dessert", calories: 250, ingredients: ["밀가루", "설탕", "초콜릿"], weatherPreference: "any", timePreference: ["snack"], groupSize: [1,2], mood: ["comfort", "quick"] },
  { id: 198, name: "에그타르트", category: "dessert", calories: 220, ingredients: ["계란", "크림", "파이지"], weatherPreference: "any", timePreference: ["snack", "breakfast"], groupSize: [1,2], mood: ["light", "comfort"] },
];